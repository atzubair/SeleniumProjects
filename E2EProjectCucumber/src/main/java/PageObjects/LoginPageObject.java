...
public class LoginPageObject {
	...
	By username=By.id("user_email");// this is the locator of username text box
	
	By password=By.id("user_password");// this is the locator of password text box
	
	By login=By.name("commit"); // this is the locator of login button box
